...
class PlasmicAction {
  ...
  init() {
    return __awaiter(this, void 0, void 0, function* () {
      const isNewApp = !fs_1.existsSync(
        path_1.default.join(this.opts.cwd, "package.json")
      );
      if (!isNewApp) {
      ...
      util_1.assertNoSingleQuotes(this.args.projectHost);
      ...
      yield exec_1.exec(
        ...
        Object.assign(Object.assign({}, this.opts), {
          cwd: path_1.default.join(this.opts.cwd, relTmpDir),
        })
      );
  ...
  updateDependencies() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (this.args.scheme === "loader") {
        ...
        if (platform) {
          yield exec_1.exec(
            `${pm.add} @plasmicapp/loader-${platform}`,
            this.opts
          );
        }
      }
  ...
  sync() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield create_plasmic_app_1.installCli(path.resolve(this.opts.cwd));
      yield exec_1.exec(
  ...
  build() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (this.args.skipIfPlasmic) {
        const { stdout: authorEmail } = yield exec_1.exec(
  ...
  detectPlatform() {
    const packageJson = fs_1.readFileSync(
      path_1.default.join(this.opts.cwd, "package.json"),
      "utf8"
    );
    const parsedPackageJson = JSON.parse(packageJson);
    if (
      fs_1.existsSync(path_1.default.join(this.opts.cwd, "gatsby-config.js"))
    ) {
      return "gatsby";
    }
    if (
  ...
  commit(branch) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { stdout: staged } = yield exec_1.exec(
      ...
      yield exec_1.exec(
        `git commit -F -`,
        Object.assign(Object.assign({}, this.opts), { input: commitMessage })
      );
