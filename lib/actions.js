...
class PlasmicAction {
    ...
    sync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield create_plasmic_app_1.installCli(path_1.default.resolve(this.opts.cwd));
            yield exec_1.exec(`${pm.cmd} plasmic sync --projects '${this.args.projectId}:${this.args.projectApiToken}' --yes${this.args.projectHost ? ` --host ${this.args.projectHost}` : ""}`, this.opts);
