...
class PlasmicApi {
  ...
  ${response.data}`;
    ...
    get codegenHost() {
        const _codegenHost = !this.auth.host || this.auth.host === config_utils_1.DEFAULT_HOST ? "https://codegen.plasmic.app" : this.auth.host;
        console.log(`_codegenHost: ${_codegenHost}`);
        return _codegenHost;
