...
+    console.log('__DEV__:post', { url2, headers: this.makeHeaders() });
     try {
...
+    console.log('__DEV__:get', { url2, headers: this.makeHeaders() });
     try {
...
+    console.log('__DEV__:post', { url, headers: this.makeHeaders() });
     try {
...
+    console.log('__DEV__:get', { url, headers: this.makeHeaders() });
     try {
