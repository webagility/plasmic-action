...
function runCodegenSync(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, lib_1.banner)(`runCodegenSync: ${projectHost || "N/A"}`);
        const project = projectApiToken
            ? `${projectId}:${projectApiToken}`
            : projectId;
        yield (0, cmd_utils_1.spawnOrFail)(`${projectHost ? `PLASMIC_DEFAULT_HOST=${projectHost} ` : ""}npx plasmic sync --yes -p ${project}`, projectPath);
    });
}
