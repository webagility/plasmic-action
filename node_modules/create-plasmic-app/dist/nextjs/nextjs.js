...
exports.nextjsStrategy = {
  create: (args) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const experimentalAppArg = (
        (_a = platformOptions.nextjs) === null || _a === void 0
          ? void 0
          : _a.appDir
      )
        ? "--app"
      ...
      const createCommand =
        `npx create-next-app@14.2.18 ${projectPath} ${typescriptArg} ${experimentalAppArg} ${templateArg}` +
  ...
  installDeps: ({ scheme, projectPath }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      if (scheme === "loader") {
  ...
  overwriteConfig: (args) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const nextjsConfigFile = path_1.default.join(
        projectPath,
        "next.config.js"
      );
      const appDirOption = (
        (_b = platformOptions.nextjs) === null || _b === void 0
          ? void 0
          : _b.appDir
      )
        ? `
...
module.exports = nextConfig;`
  ...
  generateFiles: (args) => {
    var _a;
    if (
      (_a = args.platformOptions.nextjs) === null || _a === void 0
        ? void 0
        : _a.appDir
    ) {
...
function generateFilesAppDir(args) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    (0,
    file_utils_1.deleteGlob)(path_1.default.join(projectPath, "app", "page.*"));
    // ./plasmic-init.ts
    yield fs_1.promises.writeFile(
      path_1.default.join(projectPath, `plasmic-init.${jsOrTs}`),
      (0, plasmic_init_1.makePlasmicInit_app_loader)(
        projectId,
        (0, lang_utils_1.ensure)(projectApiToken),
        projectHost
      )
    );
    // ./plasmic-init-client.ts
    yield fs_1.promises.writeFile(
      path_1.default.join(projectPath, `plasmic-init-client.${jsOrTs}x`),
      (0, plasmic_init_client_1.makePlasmicInitClient_app_loader)(jsOrTs)
    );
    // ./app/plasmic-host/page.tsx
    yield fs_1.promises.mkdir(
      path_1.default.join(projectPath, "app", "plasmic-host")
    );
    yield fs_1.promises.writeFile(
      path_1.default.join(
        projectPath,
      ...
      (0, plasmic_host_1.makePlasmicHostPage_app_loader)()
    );
    // ./app/[[...catchall]]/page.tsx
    yield fs_1.promises.mkdir(
      path_1.default.join(projectPath, "app", "[[...catchall]]")
    );
    yield fs_1.promises.writeFile(
      path_1.default.join(
        projectPath,
      ...
      (0, catchall_page_1.makeCatchallPage_app_loader)(jsOrTs)
    );
  });
}
function generateFilesPagesDir(args) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    // Delete existing pages
    (0,
    file_utils_1.deleteGlob)(path_1.default.join(projectPath, "pages", "*.*"));
    if (scheme === "loader") {
      // ./plasmic-init.ts
      yield fs_1.promises.writeFile(
        path_1.default.join(projectPath, `plasmic-init.${jsOrTs}`),
        (0, plasmic_init_2.makePlasmicInit_pages_loader)(
          projectId,
          (0, lang_utils_1.ensure)(projectApiToken),
          projectHost
        )
      ...
      yield fs_1.promises.writeFile(
        path_1.default.join(projectPath, "pages", `plasmic-host.${jsOrTs}x`),
        (0, plasmic_host_3.makePlasmicHostPage_pages_loader)()
      );
      // ./pages/[[...catchall]].tsx
      yield fs_1.promises.writeFile(
        path_1.default.join(projectPath, "pages", `[[...catchall]].${jsOrTs}x`),
        (0, catchall_page_2.makeCatchallPage_pages_loader)(jsOrTs)
      );
    } else {
      // ./pages/_app.tsx
      yield fs_1.promises.writeFile(
        path_1.default.join(projectPath, "pages", `_app.${jsOrTs}x`),
        (0, app_1.makeCustomApp_pages_codegen)(jsOrTs)
      );
      // ./pages/plasmic-host.tsx
      yield fs_1.promises.writeFile(
        path_1.default.join(projectPath, "pages", `plasmic-host.${jsOrTs}x`),
        (0, plasmic_host_2.makePlasmicHostPage_pages_codegen)()
      );
      ...
      const plasmicFiles = lodash_1.default.map(
        lodash_1.default.flatMap(config.projects, (p) => p.components),
        (c) => c.importSpec.modulePath
      );
      if (!plasmicFiles.find((f) => f.includes("/index."))) {
        yield fs_1.promises.writeFile(
          path_1.default.join(projectPath, "pages", `index.${jsOrTs}x`),
          (0, file_utils_1.generateWelcomePage)(config, "nextjs")
        );
      }
    }
  });
