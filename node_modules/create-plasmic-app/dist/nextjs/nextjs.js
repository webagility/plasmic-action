...
const plasmic_auth_1 = require("./templates/plasmic-auth");
...
exports.nextjsStrategy = {
    ...
    installDeps: (args) => __awaiter(void 0, void 0, void 0, function* () {
        const { scheme, projectPath } = args;
        yield installPatchPackage(args);
        if (scheme === "loader") {
...
function installPatchPackage(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { projectPath } = args;
        (0, lib_1.banner)(`installPatchPackage`);
        yield generatePatchFiles(args);
        ...
        yield (0, npm_utils_1.installUpgrade)("patch-package@^6", { 
            workingDir: projectPath,
        });
        (0, lib_1.banner)(`package.json`);
        console.log(JSON.stringify(JSON.parse(yield fs_1.promises.readFile(packageJsonFile, 'utf8')), null, 2));
    });
}
function generatePatchFiles(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { projectPath } = args;
        (0, lib_1.banner)(`generatePatchFiles`);
        // ./patches/
        yield fs_1.promises.mkdir(path_1.default.join(projectPath, "patches"));
        // ./patches/@plasmicapp+cli+0.1.330.patch
        yield fs_1.promises.writeFile(path_1.default.join(projectPath, "patches", "@plasmicapp+cli+0.1.330.patch"), (0, plasmic_patch_1.makePlasmicPatch_plasmicapp_cli)());
    });
}
function generateAuthFile(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { projectPath, projectHost } = args;
        (0, lib_1.banner)(`generateAuthFile: ${projectHost || "N/A"}`);
        // ./.plasmic.auth
        yield fs_1.promises.writeFile(path_1.default.join(projectPath, ".plasmic.auth"), (0, plasmic_auth_1.makePlasmicAuth)(projectHost));
    });
}
function generateFilesAppDir(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { projectPath, jsOrTs, projectId, projectApiToken, projectHost } = args;
        (0, lib_1.banner)(`generateFilesAppDir: ${projectHost || "N/A"}`);
...
function generateFilesPagesDir(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, lib_1.banner)(`generateFilesPagesDir: ${projectHost || "N/A"}`);
        // Delete existing pages
