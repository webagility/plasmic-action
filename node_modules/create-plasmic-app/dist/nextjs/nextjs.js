...
function generateAuthFile(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { projectPath, projectApiToken, projectHost } = args;
        (0, lib_1.banner)(`generateAuthFile: ${projectHost || "N/A"}`);
        // ./.plasmic.auth
        yield fs_1.promises.writeFile(path_1.default.join(projectPath, ".plasmic.auth"), (0, plasmic_auth_1.makePlasmicAuth)("admin@example.com", (0, lang_utils_1.ensure)(projectApiToken), projectHost));
    });
}
